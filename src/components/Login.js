...
function Login ({isLoggedIn, handleLogin}) {
    ...
    return (
            ...
            <section className="authorization content__authorization">
              ...
              <form name="register" className="authorization__from" onSubmit={handleSubmit}>
                  <label className="authorization__from-field">
                      ...
                      required
                      />
                      <span className="authorization__from-error authorization-email-error authorization__from-error_active">{errors.email}</span>
                  </label>
                  <label className="authorization__from-field">
                      <input
                      ...
                      required
                      />
                      <span className="authorization__from-error authorization-password-error authorization__from-error_active">{errors.password}</span>
                  </label>
